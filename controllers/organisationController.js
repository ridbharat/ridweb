...
const registerOrganisation = async (req, res) => {
  try {
    if (
      ...
      !req.files.certificateFile1 ||
      !req.files.certificateFile2 ||
      !req.files.certificateFile3
    ) {
    ...
    console.log(
      "Certificate File 1 successfully uploaded:",
    ...
    console.log(
      "Certificate File 2 successfully uploaded:",
    ...
    console.log(
      "Certificate File 3 successfully uploaded:",
      uploadedCertificateFile3.secure_url
    );
